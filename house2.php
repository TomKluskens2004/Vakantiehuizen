...
<div class="house-details">
  ...
  <script src="js/swiper.js"></script>   
        ...
        <script src="js/review2.js"></script>
        <hr class="line">
<div class="modal" id="reviewModal" style="display: none;">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="review-form">
                        <form action="submit-review2.php" method="POST" onsubmit="showSuccessMessage()">
    ...
    <script>
        ...
        <div class="home-desc">
          ...
          <script src="js/house2.js"></script>   
        <hr class="line">
        <div class="map">
            <h3>Location on map</h3>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d800862.63746687!2d-0.9805589096918258!3d38.363568703299435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd630f4337cd5d2b%3A0x4184de8e0223252d!2sCosta%20Blanca%2C%20Alicante%2C%20Spain!5e0!3m2!1sen!2sbe!4v1686079448346!5m2!1sen!2sbe" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>            <div class="home-desc">
